...
class Blockchain:
    ...
    def get_balance(self):
        ...
        tx_involving_user = [[tx.amount for tx in block.transfers
                              if tx.user == user] for block in self.__chain]
    ...
    def credit_points(self, user, amount=0.0):
    ...
    def debit_points(self, user, amount=0.0):
...
#     return False
    ...
    def mine_block(self):
        ...
        reward_transaction = Transfer(self.hosting_node, MINING_REWARD)
